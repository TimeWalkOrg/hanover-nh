...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Hanover&box=-72.243755,43.745218,-72.355668,43.664369
...
-----------
  ...
  * Hanover Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Hanover Height Map (SRTM3 v4.1).png
  ...
  * Hanover Height Map (SRTM30 Plus).png
  ...
  * Hanover Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 95m (actual) is equal to 40m in
